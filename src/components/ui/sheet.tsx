...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-background p-6 shadow-lg transition ease-in-out data-closed:duration-150 data-open:duration-150 data-open:animate-in data-closed:animate-out",
  {
    variants: {
      side: {
        ...
        {showCloseButton && (
          <DialogPrimitive.Close asChild>
            <Button
              variant="ghost"
              size="icon-sm"
              className="absolute top-4 right-4 focus:ring-2 focus:ring-ring focus:outline-hidden disabled:pointer-events-none data-[state=open]:bg-secondary"
            >
